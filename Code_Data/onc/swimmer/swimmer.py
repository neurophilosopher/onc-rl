...
class TWsearchEnv:
    ...
    def load_tw(self, filename):
        ...
        self.lif.AddBiSensoryNeuron(1, 6, -10, 10)
        self.lif.AddBiSensoryNeuron(7, 0, -10, 10)
...
def experiment(partial_obs=False):
    ...
    if partial_obs:
        plt.title("Swimmer with Partial Obs. - ONC with ARS")
    else:
        plt.title("Swimmer - ONC with ARS")
...
def demo_run():
    ...
    if args.optimize:
        ...
        twenv.input_range_path = os.path.join(CURRENT_DIR, "swimmer_input_range.txt")
        print("Replay")
